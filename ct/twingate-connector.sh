#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/Twingate-Community/ProxmoxVE/refs/heads/feat/twingate-connector/misc/build.func)
...
function update_script() {
  ...
  if [[ ! -d /lib/systemd/system/twingate-connector.service ]]; then
